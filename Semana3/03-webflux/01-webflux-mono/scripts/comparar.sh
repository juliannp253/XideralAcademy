...
# latencia simulada (300 ms). Lo unico que cambia es si el hilo se queda esperando.
#
...
cat <<TXT
  ...
  La leccion NO es "reactivo es rapido". Las dos rutas tardan 300 ms en el dato.
